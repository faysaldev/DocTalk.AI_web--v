...
const uiSlice = createSlice({
  ...
  reducers: {
    ...
    toggleDialog: (state, action) => {
      state.isDialogOpen = action.payload !== undefined ? action.payload : !state.isDialogOpen;
    },
...
export const { showToast, hideToast, toggleDialog, toggleSidebar } = uiSlice.actions;
